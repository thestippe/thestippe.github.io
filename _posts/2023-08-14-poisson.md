...
![NegativeBinomial check trace](/docs/assets/images/negbin_check_trace.jpg)

Let us now sample the posterior predictive and see if it describes the data:
...
![NegativeBinomial check ppc](/docs/assets/images/negbin_check_ppc.jpg)
...
![Alt text](/docs/assets/images/negbin_ppc.jpg)
